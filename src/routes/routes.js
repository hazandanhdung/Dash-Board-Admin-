...
const routes = [
  {
    ...
    children: [
...

      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "demo" */ "../views/Department/DepartmentList.vue"
          ),
      },
      {
        path: "/department-add",
      ...
      },
      {
        ...
        // which is lazy-loaded when the route is visited.
        component: () =>
          import(/* webpackChunkName: "demo" */ "../views/Doctor/DoctorList"),
      },
      {
        path: "/patient",
        name: "Patient",
        ...
        // which is lazy-loaded when the route is visited.
        component: () =>
          import(/* webpackChunkName: "demo" */ "../views/Patient/PatientList"),
      },
      {
        path: "/nurse",
        name: "Nurse",
        ...
        // which is lazy-loaded when the route is visited.
        component: () =>
          import(/* webpackChunkName: "demo" */ "../views/Nurse/NurseList"),
      },
      {
        path: "/pharmacist",
        name: "Pharmacist",
        ...
        component: () =>
          import(
            /* webpackChunkName: "demo" */ "../views/Pharmacist/PharmacistList"
          ),
      },
